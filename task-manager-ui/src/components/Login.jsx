...
export default function Login({ setToken }) {
  ...
  return (
    <div className="min-w-screen h-screen flex w-full">
      {/* Left Section with "WORKNEST" Name */}
      <div className="min-w-[50%] bg-secondary-dark hidden items-center justify-center lg:flex relative">
      <div className="absolute top-0 left-1/2 transform -translate-x-1/2 pt-10">
  <h1 className="text-5xl font-extrabold text-white tracking-tight">WorkNext</h1>
</div>
